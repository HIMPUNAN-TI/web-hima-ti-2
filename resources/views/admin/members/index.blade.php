            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="membersTable" class="table card-table table-vcenter text-nowrap">
                            <thead>
                                <tr>
                                    <th class="w-1">#</th>
                                    <th>Nama</th>
                                        ...
                                        <td class="text-end">
                                            <div class="btn-list">
                                                ...
                                                <button type="button" class="btn btn-danger delete-member"
                                                    ...
                                                    data-member-name="{{ $member->user->name ?? $member->nim }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-member', function() {
                ...
                Swal.fire({
                    ...
                    text: `Apakah Anda yakin ingin menghapus member "${memberName}"?`,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        const form = $('<form>', {
                            method: 'POST',
                            action: `{{ route('members.index') }}/${memberId}`
                        });
